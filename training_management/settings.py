...
SECRET_KEY = 'django-insecure-yj35y_8b4z(-(ob#%4nd^lvygg1mmpeczi&l5zbqcvd7ua-r^k'
...
MIDDLEWARE = [
    ...
    'service.utils.middleware.GlobalExceptionMiddleware',
]

ROOT_URLCONF = 'training_management.urls'
# settings.py ke aakhir mein add karein
APPEND_SLASH = False
